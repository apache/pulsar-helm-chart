...
1. kubectl 1.24 or higher, compatible with your cluster ([+/- 1 minor release from your cluster](https://kubernetes.io/docs/tasks/tools/install-kubectl/#before-you-begin))
2. Helm v3 (3.0.2 or higher)
3. A Kubernetes cluster, version 1.24 or higher.
...
You need a Kubernetes cluster whose version is 1.24 or higher in order to use this chart, due to the usage of certain Kubernetes features.
